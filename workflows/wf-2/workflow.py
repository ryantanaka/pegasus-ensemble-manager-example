...
local_local_storage = Directory(Directory.LOCAL_STORAGE, path=WORK_DIR / "outputs/workflow-2") \
                        .add_file_servers(FileServer(
                                url="file://" + str(WORK_DIR / "outputs/workflow-2"),
                                operation_type=Operation.ALL
                            )
                        )
